...
charCodeList - Convert a string into an Array of stirng of character codes

#### Description

```javascript
charCodeList( value, join = null ) : string | Array
```

Coverts a string into an array of numeric character codes, optionally joins the codes with a custom string to return a string.

#### Parameters
Parameter | Type   | Default | Description
--------- | ------ |:-------:| ---
**value** | String |    -    | String to convert
**join**  | String |   null  | If set the result Array will be joined with this string

#### Return Values
Type/Value | Description
---------- | ---
**Array**  | List of character codes
**String** | String of character codes joined with join argument
...
```javascript
str2node( str, multiple = true ) : Node
```
